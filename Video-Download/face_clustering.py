...
class FaceClustering():
    ...
    def encode(self, src_file, capture_per_second, stop=0):
        ...
        print("encoding 시작: %dx%d, %f frame/sec" % (src.get(3), src.get(4), frame_rate))
        ...
        if not os.path.exists(self.capture_dir):
            os.mkdir("./test_result/" + self.capture_dir)
        ...
        while self.run_encoding:
            ...
            pathname = os.path.join("test_result", self.capture_dir,
    ...
    def cluster(self):
        ...
        for label_id in label_ids:
            ...
            for i in indexes:
                ...
                pathname = os.path.join("test_result", dir_name, filename)
...
if __name__ == '__main__':
    ...
    pathname = os.path.join('test_result')
